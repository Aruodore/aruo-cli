...
Research remains immutable evidence for future decisions.
...
- [`ecosystem/2026-developer-tooling-state.md`](ecosystem/2026-developer-tooling-state.md) — dated survey of the 2026 tooling landscape and provisional constraints for Aruo.
