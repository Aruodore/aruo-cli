...
> Project status: **pre-0.1**. `aruo create` provides multiple qualified catalog entries, and `aruo doctor` performs versioned local repository-health assessment. Other lifecycle commands remain intentionally unavailable.
