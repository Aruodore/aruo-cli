...
The implemented rendering boundary is specified in [Template Engine Architecture](docs/architecture/template-engine.md). It deliberately returns a file plan rather than writing a repository. Discovery, composition, semantic edits, and transactional application remain separate layers.
...
See the [architecture extension checklist](docs/architecture/template-engine.md#extension-checklist) before expanding the renderer.
