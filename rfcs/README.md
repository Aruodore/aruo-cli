...
RFCs propose significant product, compatibility, governance, security, or cross-cutting implementation changes before work commits the project to them. Copy `0000-template.md`; never renumber merged RFCs. The filename is `NNNN-short-title.md`. Status and decision are updated in place while discussion remains in the PR.
...
1. Copy [`0000-template.md`](0000-template.md), choose the next number, and open a draft PR.
