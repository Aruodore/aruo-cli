...
The current sequence includes [ADR-0008: Constructor-built Cobra presentation layer](0008-constructor-built-cobra-cli.md).

[ADR-0009](0009-pure-standard-library-template-renderer.md) defines the pure standard-library template renderer.
