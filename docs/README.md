...
This directory is the user and contributor documentation source. Navigation follows user intent rather than the code tree.
...
During Phase 0, pages define intended outcomes and clearly mark unavailable commands. Runnable documentation begins with v0.1.
