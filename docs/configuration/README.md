...
Plugins are explicitly listed with pinned identity/version and granted capabilities. Manifest-requested permissions and repository grants are distinct; permission widening requires approval. See [the plugin architecture guide](../plugins/README.md).
